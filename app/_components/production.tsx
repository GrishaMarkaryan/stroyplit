...
export default function Production() {
    return (
        <div className="flex flex-col w-full mb-20">
            <div>
                <div className="flex justify-center p-4 mt-4 text-2xl xl:text-3xl lg:text-5xl font-medium"> Категории продукции </div>
                        ...
                        return (
                            <Link href={`${product.URL}`}>
                                <div key={product.id} className="flex flex-col xl:flex-row cursor-pointer h-[300px] xl:gap-10 relative hover:scale-105 duration-300 rounded-[50px] bg-stone-200">
                                    <div className="px-[60px]  pt-[30px] xl:pt-[60px] rounded-lg text-2xl 2xl:text-4xl w-[50px] z-10"> {product.name} </div>
