    ...
    return (
        <div>
            <div className="relative w-full h-[500px] md:h-[750px] flex justify-center items-center ">
                ...
                <div className="text-white px-[10%] text-[30px] md:text-[60px] bg-gray-600 bg-opacity-50   absolute z-10"> ТРОТУАРНАЯ ПЛИТКА, БОРДЮРЫ И БЛОКИ ОТ ПРОИЗВОДИТЕЛЯ В <span className="text-black font-medium">Г. СЕРГИЕВ ПОСАД</span></div>
            </div>
