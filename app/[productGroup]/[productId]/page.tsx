...
export default function Product({ params }: {
    ...
    return (
        <div className="h-svh">
            <div className="flex justify-center items-center text-3xl p-4 ml-24 m-7 bg-slate-200 rounded-xl w-2/5"> {`${productTypes.map((item) => item.name)}`} </div>
            <div className="flex justify-left flex-wrap gap-16 mx-24">
                {productTypes.map((item) =>
                    <div key={item.URL} className="flex flex-row mx-28 p-3 w-full relative">
                        ...
                        <div className="flex flex-col justify-between ml-12 gap-7 py-12">
                            ...
                            <div>
                                ...
                                <div className="flex gap-3 mt-3">
                                    ...
                                    1. у каждого продукта будут только свои возможные цвета отображаться. Т.е сейчас я все 3 цвета написал сюда, но я хочу чтобы был использован map наверное чтобы 1 раз написал FaCircle и для каждого свое количество цветов отобразилось
                                    
                                    3. создать навбар сверху
                                    */}
